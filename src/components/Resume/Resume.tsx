  ...
  return (
    <div className="">
      <div className="first-line">
        <h2 className="title m-0">{t('resume_title')}</h2>
        <a
          href={selectedCV.path}
          download
          className="download-button"
          aria-label={t('resume_download_label') + ' ' + selectedCV.lang}
        >
          <FaDownload />
        </a>
      </div>
      ...
      <div className="buttons-container">
        {cvFiles.map((file) => (
          <motion.button
            ...
            aria-label={t('resume_show_label') + ' ' + file.lang}
      ...
      <div className="visual flex justify-center">
        <div className="w-full aspect-[1/1.414] rounded-xl overflow-hidden shadow-lg bg-transparent">
          <iframe
            ...
            title={t('resume_iframe_title') + ' ' + selectedCV.lang}
